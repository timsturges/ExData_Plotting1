plot4 <- function () {
        ...
        plot(datetime,pwr_cns$Voltage,ylab="Voltage",type="n")
        lines(datetime,pwr_cns$Voltage)
        ...
        plot(datetime,pwr_cns$Global_reactive_power,
             ylab="Global_reactive_power",type="n")
        lines(datetime,pwr_cns$Global_reactive_power)
        dev.off()
}